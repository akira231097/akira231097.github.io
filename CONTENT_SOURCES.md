...
- `public/assets/lucidream-product-silent.mp4` shows a video link becoming short clips, a prompt refinement, and social drafts. `public/assets/askspice-podcast-silent.mp4` and `public/assets/askspice-research-silent.mp4` show conversational questions, answers and linked media moments in the AskSpice mobile interface. All three published files contain one H.264 video stream and no audio stream; matching posters are frames from their clips. The footage shows team-built product interfaces and does not by itself establish individual authorship of a pictured feature or verify the full architecture described on the page.
